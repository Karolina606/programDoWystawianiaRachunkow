...
//	}
	...
	public void wyswietlDodawanieRabatu(){
		...
		ArrayList<String> nazwyProduktowZRabatem = new ArrayList<>(Arrays.asList(produkty.split(",")));
	...
	public void inicjacja(){
		...
		// Dodaje produkty
		ArrayList<String> nazwyProduktow = new ArrayList<>(Arrays.asList("Pilka tenisowa", "Kapielowki meskie", "Stroj kapielowy damski", "Baton bialkowy"));
		ArrayList<Integer> ilosc = new ArrayList<>(Arrays.asList(50, 10, 8, 100));
		...
		ArrayList<String> kategoriaPodatkowa = new ArrayList<>(Arrays.asList("A", "B", "C", "D"));
		...
		ArrayList<String> listaProduktowZRabatem = new ArrayList<>(Arrays.asList("Kapielowki meskie"));
